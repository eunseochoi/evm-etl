...
func ProtoTransactionToParquet(inTx *protos.Transaction, inReceipt *protos.TransactionReceipt) (*model.ParquetTransaction, error) {
	out := model.ParquetTransaction{
		...
		QueueOrigin:       inTx.QueueOrigin,
		L1TxOrigin:        inTx.L1TxOrigin,
		L1BlockNumber:     inTx.L1BlockNumber,
		L1Timestamp:       inTx.L1Timestamp,
		Index:             inTx.Index,
		QueueIndex:        inTx.QueueIndex,
		RawTransaction:    inTx.RawTransaction,
