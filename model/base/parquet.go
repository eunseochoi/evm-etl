...
type ParquetTransaction struct {
	...
	SourceHash           string   `parquet:"name=source_hash, type=BYTE_ARRAY, convertedtype=UTF8, encoding=PLAIN_DICTIONARY"`
	Mint                 string   `parquet:"name=mint, type=BYTE_ARRAY, convertedtype=UTF8, encoding=PLAIN_DICTIONARY"`
